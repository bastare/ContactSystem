namespace ContactSystem.Infrastructure.Persistence.Context.Configurations.ConfigurationBootstrapper.MetadataCache;

public sealed class ModelMetadataCacheManager
{
	private readonly Func<Type , bool> _isEntityForCaching;

	public ImmutableList<Type> CachedModelTypes { get; } = [];
